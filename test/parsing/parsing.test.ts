...
import { PCM } from "../../src/language/generated/ast.js";

let services: ReturnType<typeof createAuroraServices>;
let parse:    ReturnType<typeof parseHelper<PCM>>;
let document: LangiumDocument<PCM> | undefined;

beforeAll(async () => {
    services = createAuroraServices(EmptyFileSystem);
    parse = parseHelper<PCM>(services.Aurora);
